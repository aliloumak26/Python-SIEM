...
class ModernSIEM(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Connexions des signaux (doivent être après build_ui)
        self.signals.new_alert.connect(self.add_alert_to_table)
        self.signals.stats_changed.connect(self.update_stats_cards)
        self.signals.log_message.connect(self.log_view.appendPlainText)
                ...
                with open(log_path, "rb") as f:
                    ...
                    for line in f:
                        ...
                        try:
                            ...
                            print(f"[Watcher] Erreur line processing: {e}")
